...
function clickeffect() {
    ...
    con.style.animation = "fadeeffect 4s";
    con.style.opacity = "0";
    head.style.display = "block";
    poke.style.color = "black";
    document.body.getAttribute('onclick');
    document.body.removeAttribute('onclick');
    image.style.animation="image1 2s ease";
    bback.style.display = "block";
...
function backchange() {
    ...
    if(a==1){
        ...
        images2.style.animation="image1 2s ease";
        image.style.animation="image1 2s ease";
        bback.style.animation="bback 2s ease"
        bback.src=colors1[b];
        bback.style.display = "block";
        bdetails.style.display='block';
        bdetails.style.color='black';
        bt.style.color='black';
        bdetails.style.animation = "moveb1 2s ease";
        bt.style.animation = "move-b1 2s ease";
        page1.style.display = "block";
        image.style.display='block';
        bt.style.display='block';
        htext.style.color='black';
        htext.style.zIndex='33';
        // bback.style.zIndex="111"
        bdetails.style.zIndex="1111"
        a=1;
